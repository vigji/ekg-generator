...
(function () {
    ...
    function updateNumerics() {
        ...
        const noHR = ['cpr', 'ventricular_fibrillation', 'fine_vf', 'ventricular_standstill', 'asystole'];
    ...
    function generateAndPush(dt) {
        ...
        while (plethSamplesRemaining.length < samplesToGenerate) {
            const noPleth = ['standby', 'cpr', 'ventricular_fibrillation', 'fine_vf', 'ventricular_standstill', 'asystole'];
